...
public class DatabaseHelper extends SQLiteOpenHelper
{
  ...
  /* Info for Place - Tag pivot table */
  ...
  /* Info for Content - Tag pivot table */
  ...
  /** Definition of place tag pivot table */
  ...
  /** Definition of content tag pivot table */
  ...
  /* Triggers names for constraints */
   ...
   * @param db SqliteDatabase to update
   * @param oldVersion old Database version id
   * @param newVersion new Database version id
   */
